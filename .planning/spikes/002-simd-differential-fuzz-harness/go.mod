module simdfuzzspike

go 1.25.5

require github.com/amikos-tech/ami-gin v0.0.0

require (
	github.com/RoaringBitmap/roaring/v2 v2.24.0 // indirect
	github.com/amikos-tech/pure-simdjson v0.1.7 // indirect
...
replace github.com/amikos-tech/ami-gin => ../../..
