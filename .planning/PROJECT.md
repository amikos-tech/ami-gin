...
- **Current milestone:** v1.2 Ingest Correctness & Per-Document Isolation — defined (see below)
...
- **v1.2 — ATOMIC-01..03, FAIL-01..02, IERR-01..03 in progress.** See `.planning/REQUIREMENTS.md` for the full list and current status across phases 16–18.
...
| Adopt validate-before-mutate atomicity (Strategy C) for v1.2 | Smallest diff that delivers the Lucene per-document contract; leverages existing two-phase architecture | Pending v1.2 |
...
---
*Last updated: 2026-04-23 — v1.2 Ingest Correctness & Per-Document Isolation milestone bootstrapped (Phases 16–18). v1.1 functionally complete; SIMD renumbered to v1.3 (Phases 19–20).*
