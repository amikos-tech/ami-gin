...
- Apache License, Version 2.0: `third_party/simdjson/LICENSE`
- MIT license: `third_party/simdjson/LICENSE-MIT`

These notices describe the license chain for the optional dependency and its
bundled source. They do not change GIN Index's MIT license or describe
`pure-simdjson` itself as Apache-2.0-only.
